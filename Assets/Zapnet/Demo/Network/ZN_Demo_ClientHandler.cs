...
public class ZN_Demo_ClientHandler : IClientHandler
{
    ...
    public INetworkPacket GetCredentialsPacket()
    {
        ...
        var packet = Zapnet.Network.CreatePacket<ZN_Demo_LoginCredentials>();
    ...
    public ZN_Demo_ClientHandler(int serverVersion)
    {
